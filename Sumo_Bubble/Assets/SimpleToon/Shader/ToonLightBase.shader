Shader "Lpk/LightModel/ToonLightBase"
{
    Properties
    {
        ...
        _ShadowStepSmooth   ("ShadowStepSmooth", Range(0, 1))     = 0.045
        [IntRange]
        _ShadowLevels       ("ShadowLevels", Range(1, 5))         = 1
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            float4 frag(Varyings input) : SV_Target
            {
               ...
               float shadowNL = 0;
               for (int i = 0; i < _ShadowLevels; i++)
               {
                   shadowNL += smoothstep(_ShadowStep - _ShadowStepSmooth, _ShadowStep + _ShadowStepSmooth, NL/_ShadowLevels * (_ShadowLevels - i));
               }
